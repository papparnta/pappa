...
%\markright{\textcolor{conceptcolor}{\tiny{\textit{Pedagogy
%University, HCM City , December 12, 2005}}}}
...
%\present{\doublebox{\includegraphics[width=10cm]{images/UAHOME_banner.jpg}
\present{\doublebox{\includegraphics[width=5cm]{images/index_banner.jpg} \
}}\\
\bigskip
...
\hspace*{2mm}$D(\texttt{\textcolor{black}{ZKUFANERFPXDKAA}})=$\\
\hspace*{2mm}$68059003759328352940
^{57173914060643780153}(\bmod79537397720925283289)=\texttt{\textcolor{red}{NEPAL}}$}
...
c$?\psd \centerline{$68059003759328352940^{57173914060643780153
...
\texttt{\textcolor{black}{ZKUFANERFPXDKAA}} is decrypted with $131$
...
% 
% 
% The running time \log^17 n is calculated using naive arithmetics.
% Fast Fourier transform brings it down to \log^11n
% 
% \end{note}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

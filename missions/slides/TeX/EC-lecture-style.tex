...
%\subject{Number Theory \lecturename}
...
\setbeamertemplate{title page}
{
  ...
  \fi%
  \vskip1em\par
   \textbf{Algebraqic Structures, Cryptography,\\ Number Theory and Applications}\\ \emph{\lecturename}\\ Universidade Cabo Verde, \insertdate\par
  \vskip0pt plus1filll
  \leftskip=0pt plus1fill\insertauthor\par
  \insertinstitute\vskip1em
}

\logo{\includegraphics[width=1cm]{images/cimpalogo.pdf}}

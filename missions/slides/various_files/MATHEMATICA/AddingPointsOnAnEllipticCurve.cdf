...
NotebookDataLength[     80169,       1587]
NotebookOptionsPosition[     53128,       1007]
NotebookOutlinePosition[     79388,       1568]
CellTagsIndexPosition[     79277,       1562]
WindowTitle->Adding Points on an Elliptic Curve
WindowFrame->Normal*)
...
Cell["Adding Points on an Elliptic Curve", "DemoTitle"],
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`pt$$ = {-1.2, 0}, Typeset`show$$ = True, 
    ...
    440., {229., 233.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`pt$112000$$ = {0, 0}}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`pt$$ = {-1.2, 0}}, 
      "ControllerVariables" :> {
        Hold[$CellContext`pt$$, $CellContext`pt$112000$$, {0, 0}]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        $CellContext`PlotEcAdd[$CellContext`pt1, {
          ...
          $CellContext`EcY[{$CellContext`a, $CellContext`b}, 
           Part[$CellContext`pt$$, 1]]}], ImageSize -> 440, PlotLabel -> Style[
          Row[{
...
$CellContext`a $CellContext`x + $CellContext`b]}], 18]], 
      "Specifications" :> {{$CellContext`pt$$, {-1.2, 0}, {-0.38, 0}, 
         ControlType -> Locator, Appearance -> Style["|", 20, 
           RGBColor[1, 0, 0]]}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{491., {260., 265.}},
...
$CellContext`x + $CellContext`b, {$CellContext`x, -5, 5}, {$CellContext`y, -4,
            ...
            Graphics[{
              ...
              Line[{$CellContext`pt3, $CellContext`pt4}]}]}], \
$CellContext`pt1 = {-1.2, 0.9338094023943001}, $CellContext`EcAdd[{
...
{$CellContext`x3, $CellContext`y3}], $CellContext`a = -3, $CellContext`b = \
...
$CellContext`b]}; Typeset`initDone$$ = True); ReleaseHold[
       HoldComplete[{$CellContext`EcAdd[{
             Pattern[$CellContext`a, 
              Blank[]], 
             Pattern[$CellContext`b, 
              Blank[]]}, 
...
$CellContext`m^2 - $CellContext`x1 - $CellContext`x2; $CellContext`y3 = \
$CellContext`m ($CellContext`x1 - $CellContext`x3) - $CellContext`y1; \
{$CellContext`x3, $CellContext`y3}]; Null, $CellContext`EcY[{
             Pattern[$CellContext`a, 
              Blank[]], 
             Pattern[$CellContext`b, 
              Blank[]]}, 
            Pattern[$CellContext`x, 
             Blank[]]] := 
          Sqrt[$CellContext`x^3 + $CellContext`a $CellContext`x + \
$CellContext`b]; Null, $CellContext`PlotEcAdd[
            Pattern[$CellContext`pt1, 
             Blank[]], 
            Pattern[$CellContext`pt2, 
             Blank[]]] := 
...
$CellContext`a $CellContext`x + $CellContext`b, {$CellContext`x, -5, 
                5}, {$CellContext`y, -4, 4}, Axes -> True, PerformanceGoal -> 
               "Quality", PlotPoints -> {15, 20}], 
              Graphics[{
                PointSize[0.02], 
                Point[{$CellContext`pt1, $CellContext`pt2, $CellContext`pt3}], 
                ColorData[1, 2], 
                ...
                ColorData[1, 3], 
                Line[{$CellContext`pt3, $CellContext`pt4}]}]}]; 
         Null, $CellContext`a = -3; $CellContext`b = -1; $CellContext`x1 = \
-1.2; $CellContext`pt1 = {$CellContext`x1, 
            $CellContext`EcY[{$CellContext`a, $CellContext`b}, \
$CellContext`x1]}; Null, $CellContext`DemoEcAdd[] := Manipulate[
           Show[
            $CellContext`PlotEcAdd[$CellContext`pt1, {
              Part[$CellContext`pt, 1], 
              $CellContext`EcY[{$CellContext`a, $CellContext`b}, 
               Part[$CellContext`pt, 1]]}], ImageSize -> 440], 
           Style[
            Row[{" Elliptic Curve Point Addition ", 
              
              TraditionalForm[$CellContext`y^2 == $CellContext`x^3 + \
$CellContext`a $CellContext`x + $CellContext`b]}], 
            18], {$CellContext`pt, {-1.2, 0}, {-0.38, 0}, Locator, Appearance -> 
            Style["|", 20, Red]}]}]]; Typeset`initDone$$ = True),
...
Cell[TextData[{
 "Elliptic curves are the solutions sets of nonsingular cubic polynomials of \
degree three. It is possible to define an addition law for these points so \
that they form an abelian algebraic group. In order to add distinct points, \
construct the line between them and determine the third point of intersection \
with the curve. The sum of the two points is then the reflection of the third \
point about the axis of symmetry, which is the ",
 Cell[BoxData[
  FormBox["x", TraditionalForm]], "InlineMath"],
 " axis for the case illustrated here. In order to add a point to itself, use \
...
Cell[TextData[{
 "For an introduction to the mathematics and applications of elliptic curves, \
see L. C. Washington, ",
 StyleBox["Elliptic Curves: Number Theory and Cryptography (Discrete \
Mathematics and Its Applications)",
  FontSlant->"Italic"],
 " [online], Boca Raton, FL: Chapman & Hall/CRC, 2003. ",
 ButtonBox["http://www.math.umd.edu/~lcw/ec.html",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://www.math.umd.edu/~lcw/ec.html"], None}],
 ".\n"
}], "DetailNotes",
 CellID->127975012],
...
Cell[TextData[{
 ButtonBox["Elliptic Curve",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/EllipticCurve.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
AddingPointsOnAnEllipticCurve&version=0008"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/AddingPointsOnAnEllipticCurve/\
AddingPointsOnAnEllipticCurve-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Adding Points on an Elliptic Curve",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/AddingPointsOnAnEllipticCurve/"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/AddingPointsOnAnEllipticCurve/"],
 "\"",
 ...
 ButtonBox["http://demonstrations.wolfram.com/AddingPointsOnAnEllipticCurve/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/AddingPointsOnAnEllipticCurve/"], 
    None},
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["John McGee",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=John+McGee"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=John+McGee"]
}], "Author",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[44101, 781, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[44362, 790, 719, 18, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[52306, 982, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 78992, 1551},
 {"Copyright", 79186, 1556}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34987, 592, 8434, 174, 70, "Output",
 CellID->342910837],
Cell[43424, 768, 674, 11, 70, "ManipulateCaption"],
Cell[44101, 781, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[44362, 790, 719, 18, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[45084, 810, 33, 0, 70, "DetailsSection"],
Cell[45120, 812, 505, 13, 70, "DetailNotes",
 CellID->127975012],
Cell[45628, 827, 44, 0, 70, "RelatedLinksSection"],
Cell[45675, 829, 567, 20, 70, "RelatedLinks",
 CellID->337397296],
Cell[46245, 851, 4826, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[51074, 942, 45, 0, 70, "CitationSection"],
Cell[51122, 944, 860, 24, 70, "Citations"],
Cell[51985, 970, 318, 10, 70, "Author"],
Cell[52306, 982, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature XREnj6qC4pCxLvQ4nvGLrL@z *)

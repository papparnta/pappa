...
SCRITTO \hfill APPELLO X - Roma, 13 Gennaio 2006. \hrule
\bigskip\noindent
...
di grado $m$ a coefficienti razionali ha dimensione su ${\bf Q}$
minore o uguale
a $m!$. %
...
Gal$(F/{\bf Q})\simeq C_3\times C_3 \times C_9$. %
...
del polinomio
$(x^2+x+1)(x^3+x^2+1)(x^4+x+1)(x^5-x)(x^{2^7}-x)$ su ${\bf F}_2$.\vv %%%%%%%%
...
\item{11.} Dopo aver definito la nozione di campo perfetto sia dia un esempio di
campo perfetto e di uno non perfetto.\vss

\item{12.} Enunciare e dimostrare il Teorema di Gauss sulla costruibilit\`a dei poligoni regolari.
\vv %%%%%%%%%%%
\ \vst

...
\itemitem{d.} E' vero che in ${\bf F}_p[X]$ due polinomi di grado $30$ si moltiplicano in $O(\log^2p)$ operazioni bit?
...
\item{1.} Rispondere alle seguenti domande che forniscono una giustificazione di 1 riga:
\itemitem{a.} Determinate due fattori propri di $10000000000000000000400000000000000000003$?

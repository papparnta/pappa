...
\voffset=0.5cm
\parskip=-.1cm
\ \vs \hskip -6mm CR410 AA12/13 (Crittografia a chiave pubblica)\hfill APPELLO C \hfill Roma, 10 Febbraio 2014. \hrule
\bigskip\noindent
...
\itemitem{c.} E' vero che se $p>3$, il polinomio $X^2+2\in{\bf F}_p$ \`e irriducibile per alcuni valori di $p$ ma non tutti?\medskip\bigskip\bigskip

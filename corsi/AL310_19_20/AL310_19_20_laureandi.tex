...
\voffset=0.5cm
\parskip=-.1cm
\ \vs \hskip -6mm AL310 AA19/20\ (Teoria delle Equazioni)\hfill APPELLO laureandi (Scritto) \hfill Roma, 18 Gennaio 2021. \hrule
\bigskip\noindent
...
\itemitem{a.} Quanti elementi ha il gruppo di Galois di $x^{120}-1?$\medskip\bigskip\bigskip

\ \dotfill\ \bigskip\bigskip\bigskip\vfil

\itemitem{b.} Esprimere $1/(\beta+2)$ come espressione polinomiale in $\beta$ nel campo ${\bf Q}[\beta], \beta^3=2$.\medskip\bigskip\bigskip

\ \dotfill\ \bigskip\bigskip\bigskip\vfil

\itemitem{c.} Quanti elementi ha il campo di spezzamento di $(X^6+X^2+2X+65)(x^{128}+x^2)\in{\bf F}_2[X]$?\medskip\bigskip\bigskip

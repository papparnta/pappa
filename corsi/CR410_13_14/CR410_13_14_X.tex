...
\voffset=0.5cm
\parskip=-.1cm
\ \vs \hskip -6mm CR410 AA13/14\ (Crittografia 1)\hfill APPELLO A \hfill Roma, 3 SETTEMBRE 2014 \hrule
\bigskip\noindent
...
\item{-} Si descrivano:
\itemitem{-1-} L'algoritmo dei quadrati successivi;\vv

\itemitem{-2-} L'algoritmo per calcolare i simboli di Jacobi (senza fattorizzare);\vv

\itemitem{-3-} L'algoritmo Baby Steps Giant Steps per il calcolo dei logaritmi discreti;
 \ve\vs
 
\itemitem{-4-} L'algorimo di Pholig--Hellman per il calcolo dei logaritmi discreti; 
\vv

\itemitem{-5-} Dopo aver descritto la nozione di algoritmo probabilistico di tipo Montecarlo, l'algoritmo di Miller--Rabin.  
\ve\vs

...
\hskip -6mm AL310 AA17/18\ (Teoria delle Equazioni)\hfill ESAME
...
hanno campi di spezzamento su ${\bf F}_p$ isomorfi? 
\medskip


\itemitem{b.} Dire quali dei seguenti numeri sono costruibili: $\sqrt{\cos(2\pi/17)}, \cos(2\pi/18), (3+3^{1/2})^{1/4}$, $120\sqrt{\pi}$?
\medskip


\itemitem{c.} Calcolare il numero di divisori di $x^{124}-1\in{\bf F}_5[x]$.
 \medskip


\itemitem{d.} \`E vero che se $f\in{\bf Q}[X]$ ha grado $2^n$ 
allora le sue radici sono costruibili?
\bigskip
